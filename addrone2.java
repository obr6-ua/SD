...
public class AD_Drone {
    public static void main(String[] args) {
        ...
        try {
            ...
            while (aux) {
                ...
                if(response == "OK"){
                    unirseAlEspectaculo(kafkaIp , kafkaPort);
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static void unirseAlEspectaculo(int kafkaIp , String kafkaPort){
        // Configuramos consumer
        KafkaConsumer<String, String> recibirDeEngine = configureKafkaConsumer(kafkaIp + ":" + kafkaPort, "groupDrones", "engineDrones");
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                String mensaje = "Mensaje para el motor";
                producer.send(new ProducerRecord<>("dronesEngine", mensaje));
            }
